...
$file['path'] = 'depositphotos_160957810-stock-photo-golden-retriever-dog.webp'; 
$data['file']= $file;
...
<nav class="navbar navbar-inverse" style="width:100%; border-radius: 0">
  <div class="container-fluid " style="padding-top:0px;">
    <ul class="nav navbar-nav">
      ...
      <li class="<?php if($lastPart=='receiveMessage'){echo 'active';}?>"><a class="<?php if($lastPart !='receiveMessage'){echo 'navv';}?>" href="receiveMessage?data=<?= urlencode($queryString) ?>">Receive nessage</a></li>
    </ul>
  </div>
</nav>