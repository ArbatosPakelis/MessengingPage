...
class CronJob extends \Daycry\CronJob\Config\CronJob
{
    ...
    */
    ...
    {
        $schedule->url(base_url() . 'public/processEmails')->named('processing-emails')->everyMinute();
        $schedule->
        call( function() 
        { 
            var_dump("hehe");
        })
        ->named('processing-emails')->everyMinute();
        // $schedule->call( function() 
        // { 
        //     $homeController = new \App\Controllers\Home();
        //     $homeController->processEmails();
        // }
        // )->everyFiveMinutes()->named( 'processing-email');
